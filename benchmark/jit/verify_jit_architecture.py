...
def verify_region_selection_contract(root: Path) -> None:
    ...
    assert_required_text(
        ...
        [
            ...
            "source_produces_rows = descriptor.source.hash_join_protocol.source_produces_rows",
            "CREATE_TABLE_AS",
            "RESULT_COLLECTOR",
            "EXPLAIN_ANALYZE",
            "TryInspectJitRegionPipeline",
...
def verify_region_execution_form_contract(root: Path) -> None:
    ...
    assert_required_text(
        ...
        "extension/jit_sljit/sljit_region_plan.cpp",
            ...
            "SljitOperatorStageKind::SOURCE",
            "SljitOperatorStageKind::SOURCE_FILTER",
            "source-filter",
            "source_filter_count",
            "SljitOperatorKernelKind::PERFECT_HASH_AGGREGATE",
                "return JitRegionExecutionForm::FUSED;",
                "ClassifySljitRegionExecutionForm(*native_region, contract)",
...
def verify_stage_region_contract(root: Path) -> None:
    ...
    assert_required_text(
        ...
        [
            ...
            "JitCompiledContractHasNativeSource",
            "JitCompiledContractHasNativeOperator",
            "JitCompiledContractHasNativeSink",
