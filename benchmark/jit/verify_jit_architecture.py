...
def verify_backend_contract_tests(root: Path) -> None:
    assert_required_text(
        ...
        [
            ...
            "JIT hash join probe keeps non-equality predicates behind explicit chain protocol blocker",
            ...
            "hash-join-native-non-equality-chain-protocol-missing",
