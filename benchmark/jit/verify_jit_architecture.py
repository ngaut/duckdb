...
def verify_recipe_builder() -> None:
    ...
    require_text(
        ...
        (
            ...
            "ops[0].kind == SljitNativeRegionOpKind::HASH_JOIN_PROBE",
    ...
    require_text(
        ...
        (
            ...
            "switch (variant)",
            "SljitProjectionAggregateRecipeVariant::SINGLE_JOIN_MARK_FILTER",
            "SljitProjectionAggregateRecipeVariant::TWO_JOIN_MARK_FILTER",
