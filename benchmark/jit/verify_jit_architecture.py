...
def verify_stale_route_code_removed() -> None:
    ...
    reject_regex(
        ...
        (
            ...
            r"\bSljitTryExecuteHashJoinFilteredUngroupedAggregateUpdate\b",
            r"\bSljitCanExecuteHashJoinUngroupedAggregateUpdate\b",
            r"\bSljitTryPrepareHashJoinFilteredUngroupedPayloadInput\b",
            r"\bCanUseGeneratedAggregateTail\b",
            r"\bdirect_hash_join_filtered_payload_update\b",
            r"\bdirect_hash_join_filtered_state_update\b",
    ...
    reject_text(
        ...
        (
            "SljitNativePipelineProjectedAggregateState",
            "SljitTryFindNativeProjectionAggregateUpdate",
            "SljitTryExecuteNativeProjectionAggregateUpdate",
            "direct_projected_input_vector_grouped_update_unsupported.",
            "SljitTryExecuteNativeFilterAggregateUpdate",
            "SljitCanExecuteFilterAggregateUpdate",
            "filter_aggregate_deferred_grouped_finish",
        ),
    )
    reject_text(
        "extension/jit_sljit/include/sljit_native_sink_runtime.hpp",
        (
            "SljitTryExecuteNativeFilterAggregateUpdate",
            "SljitCanExecuteFilterAggregateUpdate",
            "SljitCanExecuteGeneratedFilterAggregateUpdate",
        ),
    )
...
def verify_preaggregated_primitive_batch_contract() -> None:
    ...
    require_text(
        ...
        (
            ...
            "SljitPlanRowPointerGroupedAggregateUpdate",
            "try_preaggregated_primitive_groups",
...
def verify_primitive_sequence() -> None:
    ...
    require_text(
        ...
        (
            ...
            "CanBindMarkFilterBoundary",
            "CanBindDirectProjectionAggregate",
            "CanBindProjectionAggregateTail",
            "CanBindProjectionAggregateTailPrefix",
...
def verify_recipe_builder() -> None:
    ...
    require_text(
        ...
        (
            ...
            "SljitSourceFilterAggregateFacts",
    ...
    reject_text(
        ...
        (
            ...
            "MakeTwoJoinMarkFilterProjectionAggregateRecipe",
            "MakeTwoJoinMarkFilterNativeTailRecipe",
            "MakeMarkFilterProjectionAggregateRecipe(const SljitFullPipelineProjectionAggregateShape &shape, idx_t",
            "MakeMarkFilterNativeTailRecipe(idx_t",
    ...
    require_text(
        ...
        (
            ...
            "TryBuildSourceFilterAggregateRecipe",
            "SljitTryAnalyzeSourceUngroupedAggregate",
            "SljitTryAnalyzeSourceFilterAggregate",
            "binding.MakeSourceUngroupedAggregateRecipe",
            "binding.MakeSourceFilterAggregateRecipe",
        ),
    )
    require_text(
        "extension/jit_sljit/include/sljit_ungrouped_aggregate_update_primitive.hpp",
        (
            ...
            "SljitUngroupedAggregateUpdateStrategyKind",
            "FILTERED_PRIMITIVE_PAYLOAD_UPDATE",
            "struct SljitBoundUngroupedPrimitiveAggregateUpdate",
            "SljitCanBindUngroupedAggregateUpdatePrimitive",
            "SljitCanBindFilteredUngroupedAggregateUpdatePrimitive",
            "SljitBindFilteredUngroupedAggregateUpdatePrimitive",
            ...
            "SljitExecuteNativeFilteredAggregateUpdate",
    ...
    require_text(
        ...
        (
            ...
            "TryBuildMarkProjectionAggregate",
            "TryBuildMarkNativeTail",
            "TryBuildDirectProjectionAggregate",
            "TryBuildProjectionAggregateTail",
            "CanBindMarkFilterBoundary",
            "CanBindDirectProjectionAggregate",
            "CanBindProjectionAggregateTail",
            "CanBindProjectionAggregateTailPrefix",
            ...
            "binding.MakeMarkFilterProjectionAggregateRecipe(shape, facts)",
            "binding.MakeMarkFilterNativeTailRecipe(facts)",
        ),
    )
    require_text(
        "extension/jit_sljit/include/sljit_full_pipeline_recipe_facts.hpp",
...
def verify_native_tail_and_deferred_finish() -> None:
    ...
    require_text(
        ...
        (
            ...
            "native_runtime.RecordSinkResult(input.count, sink_result)",
        ),
    )
    require_text(
...
def verify_distinct_aggregate_backend() -> None:
    ...
    require_text(
        ...
        (
            ...
            "filter_idx",
            "SljitCanBindFilteredGroupedAggregateUpdatePrimitive",
