...
def runner_cost_shape(row: dict) -> str:
    ...
    parts = [
        ...
        f"gen_backend={row_int(row, 'runner_cost_generated_backend_stage_count')}",
        ...
        f"join_build_sink={row_int(row, 'runner_cost_native_hash_join_build_sink_count')}",
        ...
        f"native_distinct_ptr={row_int(row, 'runner_cost_native_distinct_count_pointer_aggregate_stage_count')}",
        f"generated_distinct_ptr={row_int(row, 'runner_cost_generated_distinct_count_pointer_aggregate_update_count')}",
