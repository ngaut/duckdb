...
FilterSelectivityState::FilterSelectivityState(const idx_t n_vectors_to_check, const float selectivity_threshold)
...
void FilterSelectivityState::Update(idx_t accepted, idx_t processed) {
	vectors_processed++;
...
bool FilterSelectivityState::IsActive() const {
	return status == Status::ACTIVE;
}
double FilterSelectivityState::GetSelectivity() const {
