...
enum JitCounterColumn : idx_t {
	...
	JIT_COUNTER_RUNNER_COST_NATIVE_DISTINCT_COUNT_POINTER_AGGREGATE_STAGE_COUNT,
	JIT_COUNTER_RUNNER_COST_GENERATED_DISTINCT_COUNT_POINTER_AGGREGATE_UPDATE_COUNT,
