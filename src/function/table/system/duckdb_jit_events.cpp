...
enum JitEventColumn : idx_t {
	...
	JIT_EVENT_RUNNER_COST_NATIVE_DISTINCT_COUNT_POINTER_AGGREGATE_STAGE_COUNT,
	JIT_EVENT_RUNNER_COST_GENERATED_DISTINCT_COUNT_POINTER_AGGREGATE_UPDATE_COUNT,
