...
public:
	...
	//! Export a backend-neutral native execution table-layout contract. This is layout/state metadata only;
	//! it must not execute join semantics.
	bool GetExecutionHashJoinTableLayout(ExecutionHashJoinTableLayout &layout) const;
