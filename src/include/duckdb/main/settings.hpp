...
// --- conceptually add new setting structs here ---

struct EnableLuajitJitSetting {
	using RETURN_TYPE = bool;
	static constexpr const char *Name = "enable_luajit_jit";
	static constexpr const char *Description = "Enable LuaJIT JIT compilation for expressions.";
	static constexpr const char *InputType = "BOOLEAN";
	// For session scope, typically only SetLocal, ResetLocal, GetSetting are defined.
	// Global equivalents might not be generated if it's purely session.
	// Assuming these are generated by the script:
	static void SetLocal(ClientContext &context, const Value &parameter);
	static void ResetLocal(ClientContext &context);
	static Value GetSetting(const ClientContext &context);
};

struct LuajitJitComplexityThresholdSetting {
	using RETURN_TYPE = int64_t;
	static constexpr const char *Name = "luajit_jit_complexity_threshold";
	static constexpr const char *Description = "Minimum expression complexity score to trigger JIT.";
...
struct LuajitJitTriggerCountSetting {
	using RETURN_TYPE = int64_t;
	static constexpr const char *Name = "luajit_jit_trigger_count";
	static constexpr const char *Description = "Minimum number of executions before an expression is JIT-compiled.";
	static constexpr const char *InputType = "BIGINT";
	static void SetLocal(ClientContext &context, const Value &parameter);
	static void ResetLocal(ClientContext &context);
	static Value GetSetting(const ClientContext &context);
