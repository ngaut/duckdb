...
static bool SljitHashJoinCanUseAllValidNoChainMarkSelectionProbe(
    const SljitNativeHashJoinProbePlan &plan, const SljitNativeRegularHashJoinProbeInput &input, bool selected,
    SljitHashJoinMarkSelectionMode mark_selection_mode) {
...
static bool SljitHashJoinCanUseAllValidChainMarkSelectionProbe(
    const SljitNativeHashJoinProbePlan &plan, const SljitNativeRegularHashJoinProbeInput &input, bool selected,
    bool can_use_chain_input, SljitHashJoinMarkSelectionMode mark_selection_mode) {
	return SljitHashJoinCanUseAllValidMarkSelectionProbe(plan, input, selected, mark_selection_mode) &&
	       can_use_chain_input;
}
...
static void ExecuteAllValidPairMarkSelectionProbeForInput(
...
static bool TryExecuteAllValidPairMarkSelectionProbeForKey1Kind(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    SljitHashJoinMarkSelectionMode mark_selection_mode) {
	auto &key1 = plan.keys[1];
	switch (key1.key_kind) {
	case SljitNativeHashJoinKeyKind::INT8:
		ExecuteAllValidPairMarkSelectionProbeForInput<KEY0, int8_t, SELECTED, CHAIN>(plan, input,
		                                                                             mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::UINT8:
		ExecuteAllValidPairMarkSelectionProbeForInput<KEY0, uint8_t, SELECTED, CHAIN>(plan, input,
		                                                                              mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::INT16:
		ExecuteAllValidPairMarkSelectionProbeForInput<KEY0, int16_t, SELECTED, CHAIN>(plan, input,
		                                                                              mark_selection_mode);
		return true;
	...
	case SljitNativeHashJoinKeyKind::INT32:
		ExecuteAllValidPairMarkSelectionProbeForInput<KEY0, int32_t, SELECTED, CHAIN>(plan, input,
		                                                                              mark_selection_mode);
		return true;
	...
	case SljitNativeHashJoinKeyKind::INT64:
		ExecuteAllValidPairMarkSelectionProbeForInput<KEY0, int64_t, SELECTED, CHAIN>(plan, input,
		                                                                              mark_selection_mode);
		return true;
...
template <bool SELECTED, bool CHAIN>
static bool TryExecuteAllValidPairMarkSelectionProbeForKey0Kind(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    SljitHashJoinMarkSelectionMode mark_selection_mode) {
	auto &key0 = plan.keys[0];
	switch (key0.key_kind) {
	case SljitNativeHashJoinKeyKind::INT8:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<int8_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::UINT8:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<uint8_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::INT16:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<int16_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::UINT16:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<uint16_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::INT32:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<int32_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::UINT32:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<uint32_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::INT64:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<int64_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::UINT64:
		return TryExecuteAllValidPairMarkSelectionProbeForKey1Kind<uint64_t, SELECTED, CHAIN>(
		    plan, input, mark_selection_mode);
	default:
		return false;
	}
...
template <bool SELECTED, bool CHAIN>
static bool TryExecuteAllValidPairMarkSelectionProbe(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    const SljitAllValidHashJoinProbeFacts &facts, SljitHashJoinMarkSelectionMode mark_selection_mode) {
	if (plan.keys.size() != 2 || plan.equality_key_count != 2 ||
	    !SljitHashJoinHasAllValidEqualityKey(plan.keys[0]) ||
	    !SljitHashJoinHasAllValidEqualityKey(plan.keys[1])) {
		return false;
	}
	if constexpr (CHAIN) {
		if (!SljitHashJoinCanUseAllValidChainMarkSelectionProbe(plan, input, SELECTED,
		                                                        facts.can_use_chain_input,
		                                                        mark_selection_mode)) {
			return false;
		}
	} else {
...
template <bool SELECTED, bool CHAIN>
static bool TryExecuteAllValidUint64PairMarkSelectionProbe(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    const SljitAllValidHashJoinProbeFacts &facts, SljitHashJoinMarkSelectionMode mark_selection_mode) {
...
static bool TryExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForPredicateKind(
	...
	case SljitNativeHashJoinKeyKind::INT8:
		...
		return true;
	case SljitNativeHashJoinKeyKind::UINT8:
		ExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForInput<KEY_SOURCE, KEY_LAYOUT, uint8_t,
		                                                                      SELECTED, CHAIN>(plan, input,
		                                                                                       mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::INT16:
		ExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForInput<KEY_SOURCE, KEY_LAYOUT, int16_t,
		                                                                      SELECTED, CHAIN>(plan, input,
		                                                                                       mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::UINT16:
		...
		return true;
	case SljitNativeHashJoinKeyKind::INT32:
		ExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForInput<KEY_SOURCE, KEY_LAYOUT, int32_t,
		                                                                      SELECTED, CHAIN>(plan, input,
		                                                                                       mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::UINT32:
		...
		return true;
	case SljitNativeHashJoinKeyKind::INT64:
		ExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForInput<KEY_SOURCE, KEY_LAYOUT, int64_t,
		                                                                      SELECTED, CHAIN>(plan, input,
		                                                                                       mark_selection_mode);
		return true;
	case SljitNativeHashJoinKeyKind::UINT64:
...
static bool TryExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForKeyKind(
	...
	switch (key.key_kind) {
	case SljitNativeHashJoinKeyKind::INT8:
		return TryExecuteAllValidSingleKeyComparisonPredicateMarkSelectionProbeForPredicateKind<int8_t, int8_t, SELECTED,
		                                                                                      CHAIN>(
		    plan, input, mark_selection_mode);
	case SljitNativeHashJoinKeyKind::UINT8:
...
template <class KEY_READER, bool SELECTED, bool CHAIN>
static void ExecuteAllValidSingleKeyMarkSelectionProbeForInput(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    SljitHashJoinMarkSelectionMode mark_selection_mode) {
	SljitHashJoinSingleKeyMatcher<KEY_READER> matcher(plan, input);
	if (mark_selection_mode == SljitHashJoinMarkSelectionMode::MATCHES) {
...
template <bool SELECTED, bool CHAIN>
static bool TryExecuteAllValidSingleKeyMarkSelectionProbeForKind(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    SljitHashJoinMarkSelectionMode mark_selection_mode) {
	auto &key = plan.keys[0];
	if (input.source_key0_int64_to_int32) {
...
template <bool SELECTED, bool CHAIN>
static bool TryExecuteAllValidSingleKeyMarkSelectionProbe(
    const SljitNativeHashJoinProbePlan &plan, SljitNativeRegularHashJoinProbeInput &input,
    const SljitAllValidHashJoinProbeFacts &facts, SljitHashJoinMarkSelectionMode mark_selection_mode) {
	if constexpr (CHAIN) {
		if (!SljitHashJoinCanUseSingleKeyProbe(plan) ||
		    !SljitHashJoinCanUseAllValidChainMarkSelectionProbe(plan, input, SELECTED,
		                                                        facts.can_use_chain_input,
		                                                        mark_selection_mode)) {
			return false;
		}
